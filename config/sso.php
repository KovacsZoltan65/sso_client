...
return [
    ...
    'oidc_session_mapping_retention_seconds' => (int) env('SSO_OIDC_SESSION_MAPPING_RETENTION_SECONDS', 604800),
    'oidc_logout_receipt_retention_seconds' => (int) env('SSO_OIDC_LOGOUT_RECEIPT_RETENTION_SECONDS', 86400),
