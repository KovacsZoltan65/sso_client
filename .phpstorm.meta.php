...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\AuditLogRepositoryInterface' => \App\Repositories\Eloquent\AuditLogRepository::class,
            'App\Repositories\Contracts\CompanyRepositoryInterface' => \App\Repositories\Eloquent\CompanyRepository::class,
            'App\Repositories\Contracts\PermissionRepositoryInterface' => \App\Repositories\Eloquent\PermissionRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\wamp64\www\sso\sso_client\public\storage' => 'string',
            ...
            'repository.pagination.limit' => 'string',
            ...
            'sso.server_base_url' => 'string',
            'sso.authorize_endpoint' => 'string',
            'sso.token_endpoint' => 'string',
            'sso.userinfo_endpoint' => 'string',
            'sso.oidc_discovery_endpoint' => 'string',
            'sso.oidc_discovery_cache_seconds' => 'integer',
            'sso.oidc_jwks_endpoint' => 'NULL',
            'sso.oidc_expected_issuer' => 'NULL',
            'sso.oidc_clock_skew_seconds' => 'integer',
            'sso.oidc_jwks_cache_seconds' => 'integer',
            'sso.backchannel_logout_replay_cache_seconds' => 'integer',
            'sso.oidc_session_mapping_retention_seconds' => 'integer',
            'sso.oidc_logout_receipt_retention_seconds' => 'integer',
            'sso.logout_endpoint' => 'string',
            'sso.logout_return_uri' => 'NULL',
            'sso.client_id' => 'string',
            'sso.client_secret' => 'string',
            'sso.redirect_uri' => 'string',
            'sso.scopes' => 'array',
            'sso.timeout' => 'integer',
            'sso.pending_auth_session_key' => 'string',
            'sso.identity_validation_session_key' => 'string',
            'sso.oidc_session_context_key' => 'string',
            'sso.logout_state_session_key' => 'string',
            'sso.local_auth_enabled' => 'boolean',
...
'app.available_locales','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\www\\sso\\sso_client\\public\\storage','ide-helper.filename',
...
'repository.pagination.limit','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'sso.server_base_url','sso.authorize_endpoint','sso.token_endpoint','sso.userinfo_endpoint','sso.oidc_discovery_endpoint',
'sso.oidc_discovery_cache_seconds','sso.oidc_jwks_endpoint','sso.oidc_expected_issuer','sso.oidc_clock_skew_seconds','sso.oidc_jwks_cache_seconds',
'sso.backchannel_logout_replay_cache_seconds','sso.oidc_session_mapping_retention_seconds','sso.oidc_logout_receipt_retention_seconds','sso.logout_endpoint','sso.logout_return_uri',
'sso.client_id','sso.client_secret','sso.redirect_uri','sso.scopes','sso.timeout',
'sso.pending_auth_session_key','sso.identity_validation_session_key','sso.oidc_session_context_key','sso.logout_state_session_key','sso.local_auth_enabled',
...
'sanctum.csrf-cookie','welcome','locale.update','dashboard',
'profile.edit','account.show','sso.status','audit-logs.index','users.index',
'companies.index','employees.index','roles.index','permissions.index','api.audit-logs.index',
'api.audit-logs.show','api.users.index','api.users.show','api.users.update','api.companies.index',
'api.companies.store','api.companies.update','api.companies.destroy','api.employees.fetch','api.employees.store',
'api.employees.update','api.employees.destroy','api.roles.index','api.roles.store','api.roles.update',
'api.roles.destroy','api.permissions.index','api.permissions.store','api.permissions.update','api.permissions.destroy',
'login','auth.sso.redirect','auth.sso.callback','auth.logout.return','auth.logout.frontchannel',
'auth.logout.backchannel','logout','storage.local','storage.local.upload',);
...
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.wamp64.www.sso.sso_client.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','api.companies.retrieved','api.companies.created','api.companies.updated','api.companies.deleted',
'api.employees.fetched','api.employees.created','api.employees.updated','api.employees.deleted','api.roles.retrieved',
'api.roles.created','api.roles.updated','api.roles.deleted','api.permissions.retrieved','api.permissions.created',
'api.permissions.updated','api.permissions.deleted','api.users.retrieved','api.users.retrieved_single','api.users.updated',
'api.audit_logs.retrieved','api.audit_logs.retrieved_single','api.sso.callback_missing_code','api.sso.callback_missing_state','api.sso.invalid_or_expired_state',
'api.sso.missing_pkce_verifier','api.sso.missing_nonce_state','api.sso.missing_valid_id_token','api.sso.token_endpoint_unreachable','api.sso.token_endpoint_invalid_json',
'api.sso.token_endpoint_error','api.sso.missing_valid_access_token','api.sso.userinfo_missing_identifier','api.sso.missing_expected_nonce','api.sso.invalid_nonce_claim',
'api.sso.nonce_verification_failed','messages.forbidden','auth.failed','auth.password','auth.throttle',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','SSO_SERVER_BASE_URL','SSO_SERVER_BASE_URL','SSO_AUTHORIZE_ENDPOINT',
'SSO_TOKEN_ENDPOINT','SSO_USERINFO_ENDPOINT','SSO_LOGOUT_ENDPOINT','SSO_CLIENT_ID','SSO_CLIENT_SECRET',
'SSO_SCOPES','SSO_TIMEOUT','SSO_REDIRECT_URI','SSO_LOCAL_AUTH_ENABLED','SSO_LOCAL_AUTH_INCIDENT_ID',
'SSO_LOCAL_AUTH_ALLOW_DEGRADED','REPOSITORY_PAGINATION_LIMIT','VITE_APP_NAME','SSO_EMERGENCY_MODE_ENABLED','SSO_EMERGENCY_MODE_REQUIRE_MANUAL_ACTIVATION',
'SSO_HEALTHCHECK_ENABLED','SSO_EMERGENCY_ACTIVATION_TTL_MINUTES','SSO_EMERGENCY_SESSION_COOKIE','SSO_EMERGENCY_ALLOW_VIEW_USERS','SSO_EMERGENCY_ALLOW_VIEW_COMPANIES',
'SSO_EMERGENCY_ALLOW_VIEW_AUDIT_LOGS',);
